...
export const NFTCard = ({ nft }) => {
    ...
    const copyAddress = async () => {
        ...
        await navigator.clipboard.writeText(nft.contract.address.slice());
            ...
            <div className="flex flex-col y-gap-2 px-2 py-3 bg-slate-100 rounded-b-md h-110">
                <div className="">
                    ...
                    <div className="flex flex-row gap-2 items-center">
                        ...
                        <button className="inline-flex items-center justify-center w-8 h-8 mr-2 bg-blue-500 hover:bg-blue-700 transition-colors duration-150 rounded-full focus:shadow-outline" onClick={copyAddress}>
                            <ClipboardCopyIcon className="w-4 h-4 text-white fill-current"/>
                        </button>
                    </div>
                </div>
